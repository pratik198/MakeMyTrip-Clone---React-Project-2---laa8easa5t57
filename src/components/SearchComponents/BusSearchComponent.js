      ...
      <div className="BusSearchComponenet_Child">
        ...
        <div className="BusSearchComponenet_Child_Input_detail">
          <div className="BusSearchComponenet_Child_Destination_Input">
            <div
              onClick={handleBusFormOpen}
              className="BusSearchComponenet_Child_FromInput"
            >
              <span>From</span>
            ...
            <div
              onClick={handleBusToOpen}
              className="BusSearchComponenet_Child_ToInput"
            >
              <span>To</span>
        ...
        <button
          onClick={handleBusSearchBtn}
          className="BusSearchComponenet_Button"
        >
          SEARCH
        </button>
      </div>
